...
- [ ] 06-01-PLAN.md - Align the detail dialog with Phase 6 scope, modal behavior, and read-only status display
- [ ] 06-02-PLAN.md - Harden vote/comment adapter wiring and add build-aware Phase 6 verification
...
- [x] 07-01-PLAN.md - Establish the shared Phase 7 status contract and feed badge semantics
- [x] 07-02-PLAN.md - Add the admin-only dialog status editor and phase-specific verification
