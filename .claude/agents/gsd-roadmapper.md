...
Reference full template: `C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/state.md`.
