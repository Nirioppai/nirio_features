...
<required_reading>
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Active Codebase/nirio_features/.claude
                  → checks C:/Active Codebase/nirio_features/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Active Codebase/nirio_features/.claude/get-shit-done
                  → writes to C:/Active Codebase/nirio_features/.claude/get-shit-done/hooks/
...
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/common-bug-patterns.md
