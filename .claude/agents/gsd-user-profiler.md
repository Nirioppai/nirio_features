...
<reference>
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Active Codebase/nirio_features/.claude/get-shit-done/references/user-profiling.md` to load:
