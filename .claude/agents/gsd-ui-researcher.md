...
Use template from `C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/UI-SPEC.md`
