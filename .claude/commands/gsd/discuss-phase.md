...
Read and execute `C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value):
Read and execute `C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/discuss-phase.md` end-to-end.
