...
<execution_context>
@C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/code-review.md
</execution_context>
...
Execute the code-review workflow from @C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/code-review.md end-to-end.
