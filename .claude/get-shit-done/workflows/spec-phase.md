...
```bash
INIT=$(node "C:/Active Codebase/nirio_features/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/spec.md.
