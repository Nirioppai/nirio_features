...
```bash
INIT=$(node "C:/Active Codebase/nirio_features/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Active Codebase/nirio_features/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
