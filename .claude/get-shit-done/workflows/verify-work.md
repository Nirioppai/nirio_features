...
Read and follow `C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/diagnose-issues.md
