...
INSTALL_JS_GLOBAL="C:/Active Codebase/nirio_features/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Active Codebase/nirio_features/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
