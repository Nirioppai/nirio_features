...
```
Task(
  prompt="Read C:/Active Codebase/nirio_features/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/SECURITY.md`
