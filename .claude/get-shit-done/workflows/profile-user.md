...
Key references:
- @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/Active Codebase/nirio_features/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Active Codebase/nirio_features/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/Active Codebase/nirio_features/.claude/get-shit-done/USER-PROFILE.md" "C:/Active Codebase/nirio_features/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Active Codebase/nirio_features/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Active Codebase/nirio_features/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/Active Codebase/nirio_features/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/Active Codebase/nirio_features/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Active Codebase/nirio_features/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Active Codebase/nirio_features/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/Active Codebase/nirio_features/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/Active Codebase/nirio_features/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Active Codebase/nirio_features/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Active Codebase/nirio_features/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/Active Codebase/nirio_features/.claude/CLAUDE.md
```
