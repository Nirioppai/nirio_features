...
```
Task(
  prompt="Read C:/Active Codebase/nirio_features/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/VALIDATION.md`
