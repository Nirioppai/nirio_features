...
<required_reading>
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/ai-frameworks.md
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Active Codebase/nirio_features/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Active Codebase/nirio_features/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Active Codebase/nirio_features/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Active Codebase/nirio_features/.claude/agents/gsd-eval-planner.md for instructions.
