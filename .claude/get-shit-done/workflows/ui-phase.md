...
```markdown
Read C:/Active Codebase/nirio_features/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Active Codebase/nirio_features/.claude/agents/gsd-ui-checker.md for instructions.
