...
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/agent-contracts.md
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/context-budget.md
@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/gates.md
</required_reading>
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/planner-antipatterns.md
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/execute-plan.md` **inline**
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Task(
     ...
     prompt="
       ...
       @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/checkpoints.md
       @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/tdd.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@C:/Active Codebase/nirio_features/.claude/get-shit-done/references/executor-examples.md'}
       </execution_context>
...
Read and follow `C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
