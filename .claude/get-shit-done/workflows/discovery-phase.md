...
See C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/discovery.md
...
Use C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/discovery.md.
