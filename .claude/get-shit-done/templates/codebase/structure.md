...
- Usage: Reference from command with `@C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Active Codebase/nirio_features/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Active Codebase/nirio_features/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
