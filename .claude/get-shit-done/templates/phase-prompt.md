...
<!-- For checkpoint task examples and patterns, see @C:/Active Codebase/nirio_features/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Active Codebase/nirio_features/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Active Codebase/nirio_features/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Active Codebase/nirio_features/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
